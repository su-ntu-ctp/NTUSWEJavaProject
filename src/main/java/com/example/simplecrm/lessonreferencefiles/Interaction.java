...
public class Interaction {
  ...
  @ManyToOne(optional = false) // optional = false means that the foreign key cannot be null
  // if this is not false, then the foreign key can be null, and you can add an
  // interaction without a customer
